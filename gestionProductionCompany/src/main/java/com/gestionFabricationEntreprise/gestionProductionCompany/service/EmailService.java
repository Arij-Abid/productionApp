...
import static com.gestionFabricationEntreprise.gestionProductionCompany.constant.EmailConstant.*;
...
public class EmailService {
    ...
    private Message createEmail(String firstName,String lastName, String password, String email) throws MessagingException {
        ...
        // Créez le contenu HTML de l'email en utilisant String.format
    String htmlContent = String.format(EMAIL_BODY, firstName, lastName, password);
